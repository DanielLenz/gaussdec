...
def reconstruct_coldens(table, sigmas=[0.0, np.inf]):
    """
...
if __name__ == "__main__":
    ...
    store = tables.open_file(
        "/users/dlenz/projects/carmago/data/carmago_gdec.h5", mode="r"
    )
    ...
    cold_components = reconstruct_coldens(gaussdec, sigmas=[0.0, 4.25])
