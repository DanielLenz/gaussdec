...
# Get filenames
indices_filename=$WORK/projects/gaussdec/data/misc/indices$basepix.npy
...
# Launch OpenMP code
python3 $WORK/projects/gaussdec/src/decompose/call_specfit.py -c True -x $indices_filename $out_filename
